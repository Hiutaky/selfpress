...
const EditCloudflare : React.FC<Props> = ({
    getRecords,
    zones
}) => {
        ...
        <div className="max-w-[480px]">
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-3">
                    <FormDescription>
                        Connect a Zone available into your Cloudflare account, the domain or subdomain you choose in the following form will be used to access this dashboard, while the root domain will be used to generate unique subdomain to be assigned to your WordPress installations, ex: fe83hf.mydomain.ltd.
                    </FormDescription>
                    <FormField
                    ...
                    </FormField>
                    {
                        ...
                        <FormField 
                            ...
                            render={ ({field}) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Choose if the dashboard should be accessible directly from the main domain (use *) or a subdomain.
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormDescription>
                            To properly connect the domain and access full SSL and Secure Connections you need to generate an Origin Cartificate via <Link href={`https://dash.cloudflare.com/${zone?.account.id}/${zone?.name}/ssl-tls/origin/certificate-form`} className=" underline" target="_blank">Cloudflare Dashboard</Link>
                        </FormDescription>
                        <FormField 
                            control={form.control}
                            name="caCertificate"
                            render={ ({field}) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Paste Origin certificate here, you can get it in your Cloudflare dashboard. 
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
